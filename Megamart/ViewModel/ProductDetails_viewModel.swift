...
//MARK: -                           Add Product To Cart
    ...
    func addToCart(product: ProductModel) {
        let product_cart = ProductBagCard_firestore(id: "\(product.id)", title: product.title, image: product.image.src, price: product.variants[0].price, count: "1", inventory_quantity: product.variants[0].inventory_quantity)
